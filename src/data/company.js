...
export const caseStudies = [
  {
    id: 1,
    client: 'India Post Payments Bank (IPPB)',
    title: 'IPPB MDM Project',
    description: 'India Post Payments Bank (IPPB) enabled doorstep banking by equipping 2.5 lakhs of postal staff with smartphones — secured and managed nationwide using Analogics MDM.',
    category: 'Banking',
    image: '',
    logo: '/images/ippb-logo.png',
    fullContent: {
      about: 'Indian Post Payments Bank (IPPB) MDM Project Overview\nIndia Post Payments Bank (IPPB) enabled doorstep banking by equipping 2.5 lakhs of postal staff with smartphones. This required a secure, scalable way to manage devices nationwide.',
      objective: 'Problem\n• No control over large-scale distributed devices\n• High risk of data misuse & unauthorized apps\n• Difficult app updates & support in rural areas',
      solution: 'Solution: Analogics MDM Implementation\n• Centralized control of all devices\n• App whitelisting (only banking apps allowed)\n• Remote lock, wipe, and troubleshooting\n• Strict usage policies (official use only)\n• Nationwide support\n\nImpact\n• Doorstep banking at scale\n• Strong data security & fraud control\n• Faster operations & onboarding\n• Reduced infrastructure cost\n\nKey Insight\nAnalogics MDM turned postmen into secure mobile bankers, proving that large-scale digital banking is possible even in rural India.'
    }
  },
  {
    id: 2,
    client: 'UP DISCOMs – DVVNL & PVVNL',
    title: 'Analogics Biometric Project',
    description: 'AI-driven mobile app for biometric facial attendance with centralized monitoring, designed for field staff, admin staff, and contractual employees across multiple locations.',
    category: 'Biometric Attendance',
    image: '',
    logo: '/logo.png',
    fullContent: {
      about: 'Analogics Biometric Project – Case Study\nClient: UP DISCOMs – DVVNL & PVVNL\n\nProject Overview\n• Value: \n• Solution: Artificial Intelligence driven Mobile app for Biometric Facial attendance\n• Locations: Sites\n• Users: Employees (field staff + admin staff + contractual employees)',
      objective: 'DISCOMs faced critical operational gaps:\n• Manual attendance leading to proxy/fraud cases\n• Lack of real-time visibility across locations for field staff\n• High administrative dependency\n• Need for contactless and scalable solution',
      solution: 'Analogics deployed an AI-driven centralized biometric facial recognition system with:\n• Secure, contactless authentication\n• Real-time monitoring dashboard\n• Multi-location scalable architecture\n• End-to-end deployment & support\n\nImpact\n• Eliminated attendance fraud\n• 100% digital attendance adoption\n• Faster processing & reduced HR and admin effort\n• Improved workforce accountability'
    }
  },
  {
    id: 3,
